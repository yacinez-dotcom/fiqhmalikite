  ...
  subjects: [
    ...
    /* ═══ Ijāra وSharika وal-muḍāraba ═══ */
    {
      ...
      badge: {
        ...
        icon: 'key-c', color: 'gold',
        unlockCondition: 'Obtenir ≥ 85 % au questionnaire ' + "Ijāra وSharika وal-muḍāraba"
      },

      lessons: [
      {
        id: "ija-01",
        title: "Ijāra — Le Contrat de Location et de Prestation",
        status: 'available',
        content: [
        ...
        {"t": "p", "v": "L'Ijāra est le transfert temporaire de l'usufruit d'un bien ou d'un service contre rémunération. Elle se divise en deux types : (1) إِجَارَةُ العَيْن — location d'un bien (maison, voiture, terrain) ; (2) إِجَارَةُ الذِّمَّة — prestation de services (travail, expertise, transport)."},
        {"t": "h", "v": "أَركَان Ijāra — Piliers du contrat"},
        { t:'ul', v:[
          "<strong>1. المُتَعَاقِدَان :</strong> bailleur et locataire — tous deux capables juridiquement.",
        ...
        { t:'ul', v:[
          "<strong>Ajīr Khāṣṣ :</strong> employé à plein temps (exclusif) — responsable seulement en cas de faute ou négligence.",
      ...
      {
        id: "ija-02",
        title: "Sharika — Les Sociétés et Partenariats Islamiques",
        status: 'available',
        content: [
      ...
      {
        id: "ija-03",
        title: "al-muḍāraba — La Commandite Islamique",
        status: 'available',
        content: [
        ...
        {"t": "p", "v": "La al-muḍāraba combine deux réalités juridiques : Rabb al-Māl, c'est une mise à disposition de capital ; pour le مُضَارِب, c'est une prestation de travail rémunérée par une part du bénéfice. C'est le système qui a permis les grandes routes commerciales islamiques."},
        ...
        { t:'ul', v:[
          ...
          "Rabb al-Māl sauf faute ou négligence du مُضَارِب.",
          "Le مُضَارِب ne reçoit rien si pas de bénéfice — son travail est son «risque».",
          "Mukhtasar Khalīl : le مُضَارِب peut stipuler une avance sur bénéfices pour ses frais de voyage."
        ] },
      ...
      {
        id: "ija-04",
        title: "Wakāla وWadīʿa — Mandat et Dépôt",
        status: 'available',
        content: [
        ...
        {"t": "p", "v": "La وَكَالَة Muwakkil délègue à Wakīl le pouvoir d'agir en son nom pour un acte juridique déterminé."},
        { t:'ul', v:[
          ...
          "Mukhtasar Khalīl : « لَا يُقِرُّ Wakīlٌ بِدَيْنٍ لِمَن لَا يَتَّهَمُهُ » — le mandataire ne peut reconnaître une dette pour son mandant sauf en présence d'une preuve."
        ] },
        ...
        {"t": "p", "v": "La وَدِيعَة est le contrat par lequel une personne confie un bien à une autre pour le garder sans rémunération."},
        { t:'ul', v:[
          "La وَدِيعَة est un contrat de bienfaisance — le gardien n'est pas rémunéré.",
        ...
        {"t": "p", "v": "Le جُعل est le contrat par lequel on promet une récompense pour la réalisation d'un résultat déterminé (retrouver un objet perdu, réaliser un travail spécifique). Contrairement à l'Ijāra, la rémunération n'est due qu'au résultat."},
        { t:'ul', v:[
        ...
        {"t": "note", "v": "Application contemporaine : les mandats bancaires, les procurations légales, les comptes séquestres (escrow) Wakāla Wadīʿa. Les coffres-forts bancaires sont des وَدِيعَة ; les fonds de placement sont des وَدِيعَة ou al-muḍāraba selon leur structure."}
        ]
      },
      {
        id: "ija-05",
        title: "Muzāraʿa وMusāqāt — Contrats Agricoles et Finance Participative",
        status: 'available',
        content: [
        ...
        {"t": "h", "v": "الفِنَانس Islāmِيَّة المُشَارِكَة — Synthèse de la Finance Participative"},
        ...
        { t:'ul', v:[
          ...
          "<strong>Ijāra المُنتَهِيَة بِالتَّمليك :</strong> crédit-bail → location qui se transforme en propriété.",
          "<strong>ṢṢukūk (sukuks) :</strong> obligations islamiques adossées à des actifs réels.",
          "<strong>al-muḍāraba bancaire :</strong> compte d'investissement où la banque est مُضَارِب."
        ] },
      ...
      quiz: {
        ...
        title: 'Questionnaire — ' + "Ijāra وSharika وal-muḍāraba",
        status: "available",
        score: null,
        questions: [
        {
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "La المَنفَعَة (usage loué) doit être licite. Si le contrat est conclu en sachant que l'usage sera illicite → l'Ijāra est invalide. Cela s'applique à toute location dont l'usage principal déclaré est حَرَام."
        },
        {
          id: "q-ija-03",
        ...
        {
          id: "q-ija-04",
          text: "<strong>PIÈGE CRUCIAL :</strong> Un tailleur abîme un vêtement qu'il devait coudre, sans aucune faute de sa part. Est-il responsable ?",
          choices: [
        ...
        {
          id: "q-ija-09",
          text: "Quelle est la différence fondamentale entre la al-muḍāraba et la شَرِكَة ?",
          choices: [
          { id:"a", text:"Aucune différence" },
          { id:"b", text:"Dans la al-muḍāraba : un apporte le capital, l'autre le travail. Dans la شَرِكَة : les deux apportent du capital et/ou du travail" },
          { id:"c", text:"La al-muḍāraba est حَرَام" },
          { id:"d", text:"La شَرِكَة est réservée aux grands projets" }
          ],
          correctId: "b",
          explanation: "La al-muḍāraba = 1 Rabb al-Māl + 1 personne apporte le travail. La شَرِكَة = les partenaires apportent tous un capital et/ou du travail. La différence clé : dans la al-muḍāraba les pertes tombent UNIQUEMENT sur le capital."
        },
        {
          id: "q-ija-10",
          text: "Dans une al-muḍāraba, si l'entreprise subit une perte sans faute du مُضَارِب, qui la supporte ?",
          choices: [
          ...
          correctId: "c",
          explanation: "Principe fondamental de la al-muḍāraba : Rabb al-Māl (celui qui a apporté le capital). Le مُضَارِب perd son travail (pas rémunéré) mais pas son patrimoine. Exception : si la perte est due à une faute ou négligence du مُضَارِب → il indemnise."
        },
        {
          id: "q-ija-11",
          text: "Le مُضَارِب peut-il s'associer avec un tiers en utilisant le capital de la al-muḍāraba ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Le مُضَارِب est mandaté Rabb al-Māl. Il ne peut pas déléguer ce mandat à un tiers Rabb al-Māl. Agir autrement engage sa responsabilité personnelle pour tout le capital."
        },
        {
          id: "q-ija-12",
        ...
        {
          id: "q-ija-13",
          text: "Le وَكِيل (mandataire) est-il responsable de la perte accidentelle du bien qu'il gère pour son mandant ?",
          choices: [
        ...
        {
          id: "q-ija-16",
          text: "Qu'est-ce que le جُعل et en quoi diffère-t-il de l'Ijāra ?",
          choices: [
          { id:"a", text:"Ils sont identiques" },
          { id:"b", text:"Dans le جُعل : rémunération due SEULEMENT en cas de succès. Dans l'Ijāra : rémunération due pour l'effort (pas seulement le résultat)" },
          { id:"c", text:"Le جُعل est حَرَام car incertain" },
          { id:"d", text:"Le جُعل est une forme de charité" }
          ],
          correctId: "b",
          explanation: "Le جُعل (prime de résultat) → rémunération conditionnée au résultat. L'Ijāra → rémunération pour la prestation elle-même (qu'elle aboutisse ou non). Exemple : « Je paie 500€ à qui retrouve mon chat perdu » = جُعل. « Je paie 500€ au détective pour 10 jours de recherche » = Ijāra."
        },
        {
          id: "q-ija-17",
        ...
        },
        {
          ...
          { id:"b", text:"al-muḍāraba : perte sur le capital seul. شَرِكَة : perte partagée selon capital. وَكَالَة : le mandataire n'est pas responsable sauf faute" },
          { id:"c", text:"Toujours sur le gérant/actif" },
          { id:"d", text:"Aucun des trois ne donne lieu à responsabilité" }
          ],
          correctId: "b",
          explanation: "Synthèse des trois contrats : (1) al-muḍāraba : perte = Rabb al-Māl, le مُضَارِب perd son travail ; (2) شَرِكَة : perte répartie selon les parts de capital (jamais autrement) ; (3) وَكَالَة : le وَكِيل est امين, responsable seulement en cas de faute ou dépassement du mandat."
        }
        ]
      }
    },
    ...
    /* ═══ Hiba وWaqf وWaṣiyya ═══ */
    {
      ...
      badge: {
        ...
        icon: 'gift-h', color: 'gold',
        unlockCondition: 'Obtenir ≥ 85 % au questionnaire ' + "Hiba وWaqf وWaṣiyya"
      },

      lessons: [
              {
        id: "hib-01",
        title: "Hiba — La Donation Islamique",
        status: 'available',
        content: [
        ...
        {"t": "h", "v": "Hiba بشرط العِوَض — Donation conditionnée à une contrepartie"},
      ...
      {
        id: "hib-02",
        title: "Waqf — La Fondation Pieuse",
        status: 'available',
        content: [
        ...
        {"t": "h", "v": "شُرُوط Waqf — Conditions de validité"},
        { t:'ul', v:[
        ...
        {"t": "h", "v": "أَنوَاع Waqf"},
        { t:'ul', v:[
          "<strong>Waqf الخَيرِيّ :</strong> directement au profit d'une institution charitable (mosquée, école, soins).",
          "<strong>Waqf الذُّرِّيّ :</strong> au profit de la famille d'abord, puis d'une cause charitable — permis en rite malikite.",
          "<strong>Waqf المُشتَرَك :</strong> plusieurs bénéficiaires simultanément."
        ] },
        {"t": "h", "v": "Gestion et administration du وَقف"},
        { t:'ul', v:[
          "Le naẓir ou mutawallī administre le وَقف selon les conditions du fondateur.",
      ...
      {
        id: "hib-03",
        title: "Waṣiyya — Le Testament Islamique",
        status: 'available',
        content: [
        {"t": "lead", "v": "La وَصِيَّة est la disposition testamentaire par laquelle une personne transfère un droit à titre gratuit après sa mort. Elle est limitée au tiers de la succession et ne peut bénéficier à un héritier légal."},
        {"t": "h", "v": "حُكم Waṣiyya — Statut"},
        { t:'ul', v:[
        ...
        { t:'ul', v:[
          "<strong>Pas de وَصِيَّة à un héritier légal</strong> — sauf accord de tous les héritiers APRÈS la mort : « لَا وَصِيَّةَ لِوَارِث ».",
        ...
        { t:'ul', v:[
          ...
          "Ordre de priorité : (1) dettes envers Allah → (2) dettes envers les hommes → (3) وَصِيَّة → (4) héritage."
        ] },
      ...
      {
        id: "hib-04",
        title: "ʿUmrā وRuqbā — Donations Viagères et Conditionnelles",
        status: 'available',
        content: [
        ...
        {"t": "p", "v": "La رُقبَى est la donation conditionnée à la mort : « si tu meurs avant moi, la maison m'appartient ; si je meurs avant toi, elle t'appartient. » — Chacun surveille l'autre."},
        { t:'ul', v:[
        ...
        { t:'ul', v:[
          ...
          "<strong>العَطِيَّة :</strong> libéralité du malade en phase terminale — limitée au 1/3 comme la وَصِيَّة, même si faite de son vivant.",
          "<strong>النِّحلَة :</strong> mention coranique de la dot (Coran 4:4) — la dot est un droit de la femme, pas une donation ordinaire."
        ] },
        {"t": "note", "v": "Point crucial — العَطِيَّة du malade en phase terminale : toute donation faite par quelqu'un en phase terminale est traitée comme une وَصِيَّة, limitée au 1/3 de la succession. Ceci empêche de contourner les droits des héritiers légaux en donnant massivement en fin de vie."}
        ]
      },
      {
        id: "hib-05",
        title: "التَّخطِيط Islāmِيّ للتَّرِكَة — Planification Successorale Contemporaine",
        status: 'available',
        content: [
        ...
        { t:'ul', v:[
          ...
          "<strong>التَّأمِين Takāfulِيّ</strong> : assurance-vie islamique — peut transmettre hors succession."
        ] },
      ...
      quiz: {
        id: 'quiz-avance-hiba',
        title: 'Questionnaire — ' + "Hiba وWaqf وWaṣiyya",
        status: 'available',
        score: null,
        questions: [
                {
          ...
          correctId: "b",
          explanation: "L'Imām Mālik dans la Muwattaʾ : « لَا تَتِمُّ Hibaُ إِلَّا بِḤḤiyāzaِ » — la donation n'est parfaite que par la prise de possession. Sans ḤḤiyāza, la donation reste révocable et non définitive."
        },
        {
          id: "q-hib-02",
          ...
          correctId: "b",
          explanation: "L'Imām Mālik : « الرُّجُوعُ فِي Hibaِ حَرَامٌ » — reprendre une donation après القَبض est حَرَام. Hadīth du Prophète ﷺ : « celui qui reprend son don est comme le chien qui revient à son vomi. » Exception unique : le père peut reprendre une donation à un enfant MINEUR si le bien n'a pas changé."
        },
        {
          id: "q-hib-03",
        ...
        },
        {
          ...
          correctId: "c",
          explanation: "Le وَقف est perpétuel et inaliénable. Exception exceptionnelle : si le bien se dégrade totalement (maison qui s'effondre, terrain improductif) et ne génère plus aucun revenu → certains savants permettent la vente uniquement pour racheter un bien équivalent qui prend le mêIstibdāl."
        },
        {
          id: "q-hib-06",
          text: "Un وَقف Waqf Dhurrī : ses revenus profitent à :",
          choices: [
          ...
          correctId: "b",
          explanation: "Le وَقف الذُّرِّيّ est permis en rite malikite — il bénéficie à la famille du fondateur pendant plusieurs générations, puis à une cause charitable après extinction de la lignée familiale. Il permet la transmission du patrimoine familial tout en préservant un but charitable final."
        },
        {
          id: "q-hib-07",
          ...
          correctId: "b",
          explanation: "Règle absolue : la وَصِيَّة est limitée au 1/3 de la succession SANS accord des héritiers. Au-delà du 1/3, elle nécessite l'accord de TOUS les héritiers APRÈS la mort du testateur. 50% → invalide pour les 17% au-delà du 1/3 sans accord."
        },
        {
          id: "q-hib-08",
          ...
          correctId: "b",
          explanation: "Hadīth : « لَا وَصِيَّةَ لِوَارِث » — pas de testament au profit d'un héritier légal (fils, fille, épouse, père...). Si le testateur le fait quand même, les autres héritiers peuvent le valider après sa mort. Sans accord → la disposition testamentaire à l'héritier est nulle."
        },
        {
          id: "q-hib-09",
        ...
        {
          id: "q-hib-10",
          text: "L'عُمرَى (donation viagère) : que se passe-t-il quand le bénéficiaire décède ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Position malikite distinctive : l'عُمرَى est une donation permanente selon l'Imām Mālik. Hadīth du Prophète ﷺ : « ʿUmrā جَائِزَةٌ لِأَهلِهَا » — elle est définitive pour ses bénéficiaires. Le bien n'est PAS récupérable à la mort du bénéficiaire, contrairement à ce que stipule parfois le donateur."
        },
        {
          id: "q-hib-11",
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Mukhtasar Khalīl : « حُبِّسَ الأَصلُ وَسُبِّلَ الثَّمَرَةُ » — le capital est immobilisé mais les fruits (revenus, loyers, récoltes) sont distribués librement selon les conditions du fondateur. Ces revenus peuvent aller aux pauvres, à une école, à une famille, ou financer l'entretien du bien lui-même."
        },
        {
          id: "q-hib-17",
          text: "Qu'est-ce que l'Istibdāl dans le contexte du وَقف ?",
          choices: [
          ...
          correctId: "b",
          explanation: "L'Istibdāl est la vente exceptionnelle d'un bien وَقف devenu totalement inutile (ruiné, improductif) pour acheter un bien équivalent qui prend les mêmes conditions de وَقف. C'est la seule exception à l'inaliénabilité du وَقف. Certains savants malikites le permettent sous contrôle judiciaire strict."
        },
        {
          id: "q-hib-18",
          text: "Ibrahim lègue 40% de sa succession à une mosquée. Ses deux fils adultes acceptent après sa mort. La وَصِيَّة est-elle valide ?",
          choices: [
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Synthèse des trois instruments : Hiba = donation entre vifs, révocable avant القَبض, définitive après. Waqf = immobilisation permanente d'un bien pour une cause, inaliénable et perpétuel. Waṣiyya = disposition après décès, limitée au 1/3, invalidée pour les héritiers légaux sauf accord."
        }
        ]
      }
    },
    ...
    /* ═══ Farāʾiḍ — Mīrāth ═══ */
    {
      ...
      badge: {
        ...
        icon: 'tree-f', color: 'gold',
        unlockCondition: 'Obtenir ≥ 85 % au questionnaire ' + "Farāʾiḍ — Mīrāth"
      },

      lessons: [
              {
        id: "far-01",
        title: "مُقَدِّمَة فِي عِلمِ Farāʾiḍ — Introduction à la Science des Successions",
        status: 'available',
        content: [
        {"t": "lead", "v": "العِلمُ بِFarāʾiḍ — la science des successions islamiques — est l'une des disciplines les plus précises du فقه islamique. Le Prophète ﷺ l'a appelée « la moitié du savoir » et a recommandé de l'apprendre et de l'enseigner."},
        ...
        {"t": "p", "v": "Le calcul des parts se fait en 3 étapes : (1) identifier les héritiers présents ; (2) appliquer les حُجُوب (exclusions) ; (3) calculer les parts selon les règles coranique + malikites. En cas de dépassement total → ʿAwl. En cas de résidu → Radd ʿAṣaba."},
      ...
      },
      {
        ...
        status: 'available',
        content: [
        {"t": "lead", "v": "Il existe deux grandes catégories d'héritiers en droit islamique : Aṣḥāb al-Furūḍ (héritiers à parts fixes coraniques) et les عَصَبَة (héritiers résiduels mâles agnatiques). La Risāla et le Mukhtasar Khalīl en établissent les listes précises."},
        ...
        {"t": "p", "v": "L'عَصَبَة prend le résidu après les parts fixes. Si rien ne reste → zéro. Si tout reste → tout."},
        { t:'ul', v:[
      ...
      {
        id: "far-03",
        title: "ḤḤujūb والمَوَانِع — Exclusions et Blocages",
        status: 'available',
        content: [
        {"t": "lead", "v": "Le système de حُجُوب (exclusions) est central pour comprendre qui hérite réellement dans une succession complexe. Il y a deux types : ḤḤajbُ الكُلِّي (exclusion totale) et ḤḤajbُ الجُزئِيّ (réduction de part)."},
        {"t": "h", "v": "Ḥajb al-ḤḤajb al-Ḥirmān — L'Exclusion Totale"},
        ...
        {"t": "h", "v": "ḤḤajb al-Nuqṣān — La Réduction de Part"},
        { t:'ul', v:[
      ...
      {
        id: "far-04",
        title: "ʿAwl وRadd — Ajustements de la Succession",
        status: 'available',
        content: [
        {"t": "lead", "v": "Deux situations exceptionnelles se produisent : ʿAwl quand les parts fixes dépassent 1 (la totalité) ; Radd quand les parts fixes n'atteignent pas 1 et qu'il reste un résidu sans عَصَبَة."},
        ...
        { t:'ul', v:[
          "Le وَ ʿAwl débute à partir de la valeur 6 (base de calcul la plus commune).",
        ...
        {"t": "p", "v": "Si les parts fixes ne totalisent pas 1 et qu'il n'y a pas d'عَصَبَة, le résidu revient aux أَصحَاب الفُرُوض en proportion de leurs parts. C'Radd."},
        { t:'ul', v:[
          "Exemple : une fille (1/2) et une mère (1/6) = 2/3 total. Reste 1/3 sans عَصَبَة → Radd : la fille reçoit 3/4 et la mère 1/4 du total.",
          "<strong>Spécificité malikite fondamentale : Radd sur le conjoint — INTERDIT.</strong> L'époux et l'éRadd.",
          "Si la fille est seule sans عَصَبَة : elle reçoit 1/2 (sa part) + Radd du reste = tout.",
        ...
        {"t": "note", "v": "Radd par rapport aux autres écoles : Radd sur le conjoint. Les malikites (et chāfiʿites) ne le permettent pas. Cette différence a des conséquences concrètes importantes : si une femme décède sans عَصَبَة ni autre héritier qu'un époux et une fille, Bayt al-Māl (État islamique) selon les malikites."}
        ]
      },
      {
        id: "far-05",
        ...
        {"t": "h", "v": "Cas 4 : Fille seule + Pas d'عَصَبَة"},
        { t:'ul', v:[
          "Fille : 1/2 (part fixe).",
          "Reste : 1/2 sans عَصَبَة → Radd sur la fille.",
          "Résultat : la fille prend tout (100%) Radd."
        ] },
        {"t": "h", "v": "Cas 5 : Épouse + Fille + Pas d'عَصَبَة"},
        { t:'ul', v:[
        ...
        {"t": "note", "v": "Pour calculer : (1) lister les héritiers ; (2) appliquer les حُجُوب ; (3) additionner les parts fixes ; (4) si total > 1 → ʿAwl ; (5) si total < 1 et عَصَبَة → ils prennent le reste ; (6) si total < 1 et pas d'عَصَبَة → Radd (sauf sur conjoint selon les malikites) ; (7) si total < 1 et personne d'autre → Bayt al-Māl."}
        ]
      },
      {
        id: "far-06",
        title: "Farāʾiḍ المُعَاصِرَة — Succession Islamique Contemporaine",
        status: 'available',
        content: [
        ...
        {"t": "h", "v": "Ṭalāq والوَفَاة — Divorce et décès"},
        { t:'ul', v:[
          "Si le mari décède pendant l'عِدَّة d'un ṬṬalāq Rajʿī → l'épouse hérite toujours (le mariage est encore en vigueur).",
          "Si le mari décède après ṬṬalāq Bāʾin → l'épouse n'hérite pas.",
        ...
        { t:'ul', v:[
          "L'Islam interdit la filiation adoptive — l'enfant adopté n'hérite pas par التَّبَنِّي.",
      ...
      quiz: {
        ...
        title: 'Questionnaire — ' + "Farāʾiḍ — Mīrāth",
        status: 'available',
        score: null,
        questions: [
                {
          ...
          correctId: "b",
          explanation: "Hadīth : « تَعَلَّمُوا Farāʾiḍَ... فَإِنَّهَا نِصفُ العِلمِ » — les فَرَائِض constituent la moitié du savoir islamique. Le Prophète ﷺ a ajouté qu'elles seraient les premières à disparaître — d'où l'urgence de les apprendre et d'enseigner."
        },
        {
          id: "q-far-02",
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Coran 4:11 : la mère reçoit 1/3 si le défunt n'a pas d'enfants et ne laisse pas plusieurs frères/sœurs. Sinon elle reçoit 1/6. Elle ne peut jamais être complètement exclue — au minimum 1/6. ḤḤajb al-Nuqṣān (réduction) mais jamais Ḥajb al-ḤḤajb al-Ḥirmān (exclusion totale)."
        },
        {
          id: "q-far-10",
          text: "Qu'ʿAwl ?",
        ...
        {
          id: "q-far-11",
          text: "<strong>SPÉCIFICITÉ MALIKITE CRUCIALE :</strong> Radd (retour du surplus) s'applique-t-il à l'époux/épouse en rite malikite ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Spécificité malikite fondamentale : Radd sur le conjoint est INTERDIT. Si reste un surplus sans عَصَبَة, Bayt al-Māl (État islamique), PAS à l'époux/épouse. C'est une difféRadd sur le conjoint."
        },
        {
          id: "q-far-12",
        ...
        {
          id: "q-far-14",
          text: "Un homme décède en laissant : une fille seule, sans عَصَبَة ni autre héritier. Que reçoit-elle en rite malikite ?",
          choices: [
          ...
          correctId: "b",
          explanation: "La fille seule : part fixe = 1/2. Pas d'عَصَبَة → Radd du reste (1/2) sur la fille. Elle prend donc 100%. Radd est permis sur les أَصحَاب الفُرُوض sauf le conjoint."
        },
        {
          id: "q-far-15",
          text: "<strong>Radd MALIKITE :</strong> Épouse + Fille. Pas d'عَصَبَة.",
          choices: [
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Position malikite : si le mari divorce en ṬṬalāq Bāʾin en état de mَرَض المَوْت dans le but manifeste de priver l'épouse de son héritage → la femme hérite quand même. L'Islam protège l'épouse contre cette manœuvre malveillante."
        },
        {
          id: "q-far-18",
          ...
          correctId: "b",
          explanation: "L'Islam interdit le التَّبَنِّي (adoption conférant la filiation) — Coran 33:4-5. L'enfant adopté ne porte pas le nom du père adoptif et n'héNasab. Des alternatives existent : هِبَة de son vivant, وَصِيَّة dans le 1/3, assurance-vie islamique."
        },
        {
          id: "q-far-19",
          text: "Comment la فِرَاش du grand-père s'articule-t-elle avec les frères selon l'école malikite ?",
          choices: [
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Avec un fils : père 1/6 + 1/6 mère + fils prend le reste (2/3) comme عَصَبَة. Le père et la mère ne sont jamais totalement exclus — au minimum 1/6 chacun."
        },
        {
          id: "q-far-22",
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "La grand-mère maternelle est soumise au Ḥajb al-ḤḤajb al-Ḥirmān (exclusion totale) par la mère. Si la mère est vivante → la grand-mère ne reçoit rien. Si la mère est décédée → la grand-mère reçoit 1/6."
        },
        {
          id: "q-far-25",
          ...
          correctId: "b",
          explanation: "Héritiers jamais totalement exclus : l'époux (1/2 ou 1/4), l'épouse (1/4 ou 1/8), le père (1/6 minimum), la mère (1/6 minimum), les descendants directs (fils/fille). Tous les autres peuvent être totalement exclus par Ḥajb al-ḤḤajb al-Ḥirmān selon les héritiers présents."
        }
        ]
      }
    },
    ...
    /* ═══ Aymān وNudhūr ═══ */
    {
      ...
      badge: {
        ...
        icon: 'seal-h', color: 'gold',
        unlockCondition: 'Obtenir ≥ 85 % au questionnaire ' + "Aymān وNudhūr"
      },

      lessons: [
              {
        id: "aym-01",
        title: "أَنوَاع Aymān — Les Types de Serments",
        status: 'available',
        content: [
        ...
        { t:'ul', v:[
          ...
          "<strong>Pas de كَفَّارَة :</strong> ce serment est si grave que la كَفَّارَة ne suffit pas — Tawba sincère peut l'effacer.",
        ...
        {"t": "note", "v": "Spécificité malikite : l'Imām Mālik considère que jurer par le Coran entraîne une كَفَّارَة si rompu, alors que jurer « par le Coran » sans mentionner Allah n'est qu'une formule makrūh sans كَفَّارَة. Cette nuance est propre à l'école malikite."}
        ]
      },
      {
        id: "aym-02",
        title: "كَفَّارَةُ al-yamīn — L'Expiation du Serment Brisé",
        status: 'available',
        content: [
        {"t": "lead", "v": "La كَفَّارَةُ al-yamīn est l'Yamīn al-Munʿaqida par acte volontaire. Elle est fixée par le Coran (5:89) et précisée par le Mukhtasar Khalīl."},
        ...
        { t:'ul', v:[
          ...
          "<strong>Spécificité malikite sur l'ordre :</strong> les 3 premières options (nourriture, vêtement, esclave) sont au CHOIX du débiteur — pas de hiérarchie entre elles. Contrairement aux كَفَّارَات ordonnées qui ont un ordre impératif."
        ] },
        ...
        {"t": "h", "v": "ḤḤinth — Rompre le serment et ses conséquences"},
        { t:'ul', v:[
          ...
          "Si on était contraint → pas de كَفَّارَة."
        ] },
      ...
      {
        id: "aym-03",
        title: "Nadhr وأَحكَامُه — Les Vœux et leurs Règles",
        status: 'available',
        content: [
        ...
        {"t": "h", "v": "أَنوَاع Nadhr"},
        { t:'ul', v:[
          "<strong>Nadhr المُعَلَّق (conditionnel) :</strong> « si Allah guérit mon père, je jeûnerai 3 jours. » Si la condition se réalise → l'acte devient obligatoire.",
          "<strong>Nadhr المُطلَق (absolu) :</strong> « je fais vœu de prier 2 rakʿāt pour Allah. » → Obligatoire immédiatement.",
          ...
          "<strong>Nadhr في المَعصِيَة :</strong> vœu d'accomplir un péché → NE DOIT PAS être exécuté. Pas de كَفَّارَة selon l'Imām Mālik — on se repent."
        ] },
        {"t": "h", "v": "حُكم Nadhr"},
        { t:'ul', v:[
        ...
        {"t": "h", "v": "كَفَّارَة Nadhr — Expiation du vœu non tenu"},
        { t:'ul', v:[
          "Si le نَذر est possible mais non exécuté → كَفَّارَةُ al-yamīn (selon une position malikite).",
          "Si le نَذر est impossible à exécuter → كَفَّارَةُ al-yamīn.",
      ...
      },
      {
        ...
        { t:'ul', v:[
          "<strong>Serment devant tribunal :</strong> « je jure de dire la vérité » — si on prête ce serment au nom d'Allah, c'est une يَمِين مُنعَقِدَة. Mentir sous serment = Yamīn al-Ghammūs = péché majeur.",
        ...
        { t:'ul', v:[
          "« والله » dans la conversation ordinaire sans intention de jurer → Yamīn al-Laghw.",
        ...
        { t:'ul', v:[
          ...
          "<strong>Vœu impossible à tenir</strong> : « si je guéris, je ferai le حَجّ » mais pas les moyens → remplacé par كَفَّارَةُ al-yamīn."
        ] },
      ...
      quiz: {
        ...
        title: 'Questionnaire — ' + "Aymān وNudhūr",
        status: 'available',
        score: null,
        questions: [
                {
          id: "q-aym-01",
          text: "Yamīn al-Ghammūs : quelle est sa كَفَّارَة ?",
          choices: [
          ...
          correctId: "c",
          explanation: "Yamīn al-Ghammūs (serment délibérément faux sur le passé) est un péché si grave qu'il n'a pas de كَفَّارَة — il est au-delà de l'expiation rituelle. Tawba sincère (repentir, regret, résolution) peut l'effacer. C'est une distinction fondamentale dans le fiqh malikite."
        },
        {
          id: "q-aym-02",
          text: "Ibrahim dit en conversation « والله j'aime ce plat » sans intention de jurer. Y a-t-il une كَفَّارَة si c'est faux ?",
          choices: [
          { id:"a", text:"Oui — tout serment par Allah engage" },
          { id:"b", text:"Non — c'Yamīn al-Laghw (involontaire), pardonné sans كَفَّارَة" },
          { id:"c", text:"Makrūh seulement" },
          { id:"d", text:"Oui si répété souvent" }
          ],
          correctId: "b",
          explanation: "Coran 2:225 : « Allah ne vous tiendra pas rigueur des serments involontaires. » Yamīn al-Laghw = formule habituée sans intention de jurer → pas de كَفَّارَة. Yamīn al-Munʿaqida (avec intention ferme sur le futur) engage une كَفَّارَة si rompu."
        },
        {
          id: "q-aym-03",
        ...
        {
          id: "q-aym-04",
          text: "L'ordre des 3 options de كَفَّارَةُ al-yamīn est-il impératif ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Spécificité malikite : pour كَفَّارَةُ al-yamīn, les 3 premières options (nourrir 10 pauvres OU habiller 10 pauvres OU libérer un esclave) sont au choix du débiteur — pas de hiérarchie entre elles. Le jeûne de 3 jours n'est qu'un dernier recours si les 3 autres sont impossibles. Contrairement aux كَفَّارَات ordonnées comme le ظِهَار."
        },
        {
          id: "q-aym-05",
          text: "Ibrahim peut-il payer la كَفَّارَة AVANT de rompre son serment ?",
          choices: [
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Position malikite : l'oubli est une excuse dans les serments — si Ibrahim rompt son serment en ayant oublié qu'il l'avait fait, pas de كَفَّارَة. De même pour la contrainte. La كَفَّارَة n'est due que pour la violation volontaire et consciente."
        },
        {
          id: "q-aym-07",
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Le serment islamique nécessite la mention d'Allah. Sans cela, pas de يَمِين islamique et pas de كَفَّارَة si rompu. En revanche, les contrats écrits sont des engagements moraux et civils sérieux selon doctrine-malikite.fr — les violer est fautif même sans كَفَّارَة rituelle."
        },
        {
          id: "q-aym-11",
          text: "Si le نَذر accompli est impossible, que faire ?",
          choices: [
          { id:"a", text:"Attendre d'en avoir les moyens, même 20 ans" },
          { id:"b", text:"Payer la كَفَّارَةُ al-yamīn en remplacement" },
          { id:"c", text:"Le vœu est annulé automatiquement" },
          { id:"d", text:"Donner en aumône le prix du حَجّ" }
          ],
          correctId: "b",
          explanation: "Si le نَذر est devenu impossible à exécuter → position malikite : كَفَّارَةُ al-yamīn (nourrir 10 pauvres, habiller 10 pauvres, ou jeûner 3 jours). Cela libère le débiteur de son engagement sans le culpabiliser à vie."
        },
        {
          id: "q-aym-12",
          text: "Ibrahim jure « والقرآن » (par le Coran) sans mentionner le nom d'Allah. Y a-t-il une كَفَّارَة si rompu ?",
          choices: [
        ...
        {
          id: "q-aym-13",
          text: "La كَفَّارَةُ al-yamīn peut-elle être payée en argent à la place de la nourriture ou des vêtements ?",
          choices: [
        ...
        {
          id: "q-aym-14",
          text: "Un commerçant jure souvent « والله » pour convaincre ses clients. C'est :",
          choices: [
          ...
          correctId: "b",
          explanation: "Hadīth : « الحَلِفُ مَنفَقَةٌ لِلسِّلعَةِ مَمحَقَةٌ لِلبَرَكَةِ » — les serments fréquents font vendre mais effacent la بَرَكَة (bénédiction). C'est une pratique déconseillée, surtout si les serments sont parfois mensongers."
        },
        {
          id: "q-aym-15",
          text: "Quels serments n'entraînent PAS de كَفَّارَة même si brisés ?",
          choices: [
          { id:"a", text:"Aucun — tout serment engage une كَفَّارَة" },
          { id:"b", text:"Yamīn al-Ghammūs (intentionnellement faux) Yamīn al-Laghw (involontaire) n'ont pas de كَفَّارَة" },
          { id:"c", text:"Seulement les serments faits en plaisantant" },
          { id:"d", text:"Seulement les serments faits par oubli" }
          ],
          correctId: "b",
          explanation: "Récapitulatif : Yamīn al-Laghw (involontaire) → pas de كَفَّارَة (pardonné). Yamīn al-Ghammūs (délibérément faux sur le passé) → pas de كَفَّارَة mais péché majeur, Tawba. Yamīn al-Munʿaqida (serment sur action future volontaire) → كَفَّارَة si rompu."
        }
        ]
      }
    },
    ...
    /* ═══ Shahādāt وQaḍāʾ ═══ */
    {
      ...
      badge: {
        ...
        icon: 'gavel', color: 'gold',
        unlockCondition: 'Obtenir ≥ 85 % au questionnaire ' + "Shahādāt وQaḍāʾ"
      },

      lessons: [
              {
        id: "qad-01",
        title: "شُرُوطُ Shāhid — Le Témoin ÉʿAdāla",
        status: 'available',
        content: [
        ...
        {"t": "h", "v": "شُرُوط Shāhid — Les conditions"},
        { t:'ul', v:[
        ...
        { t:'ul', v:[
          "Si un témoin est سَاقِط ʿAdāla (déchu de son honorabilité) → son témoignage est irrecevable.",
          "Le juge peut demander une enquête sur l'honorabilité du téTazkiya avant d'accepter son témoignage.",
          "Les motifs de الجَرح (récusation) : condamné pour fausse accusation, criminel, menteur notoire, ennemi de la partie adverso.",
      ...
      },
      {
        ...
        status: 'available',
        content: [
        {"t": "lead", "v": "Selon la nature de l'affaire, le nombre de témoins requis et les types de preuves admissibles varient. Le rite malikite a une position originale sur plusieurs questions : le témoignage de la femme, Bayyina populaire, et la règle شَاهِد + يَمِين."},
        ...
        {"t": "h", "v": "4 témoins — Domaine exclusif du حَدّ al-zinā"},
        { t:'ul', v:[
          ...
          "Les confessions peuvent remplacer les témoins pour les حُدُود — voir leçon suivante."
        ] },
        {"t": "note", "v": "Tableau récapitulatif des preuves selon le rite malikite : حُدُود graves → 4 témoins ou 2 témoins (reste) ; قِصَاص → 2 hommes ; دُيُون → 2 hommes OU 1 homme + 2 femmes OU شَاهِد + يَمِين ; حُقُوق المرأة intime → femmes seules suffisent."}
        ]
      },
      {
        id: "qad-03",
        title: "Iqrār وal-yamīn القَضَائِيَّة — Aveu et Serment Judiciaire",
        status: 'available',
        content: [
        {"t": "lead", "v": "L'Iqrār (aveu) est le moyen de preuve le plus fort en droit islamique — « سَيِّدُ الأَدِلَّة » (le maître des preuves). L'يَمِين القَضَائِيَّة (serment judiciaire) est un autre outil essentiel pour trancher les litiges."},
        {"t": "h", "v": "Iqrār — L'Aveu"},
        { t:'ul', v:[
        ...
        {"t": "h", "v": "al-yamīn القَضَائِيَّة — Le Serment Judiciaire"},
        { t:'ul', v:[
          "<strong>يَمِين المُدَّعَى عَلَيه :</strong> si le demandeur n'a pas de preuve → le défendeur jure et gagne. « Bayyinaُ عَلَى المُدَّعِي وal-yamīnُ عَلَى مَن أَنكَر. »",
          ...
          "<strong>يَمِين Qaḍāʾ :</strong> le juge lui-même peut demander un serment supplémentaire dans certains cas douteux.",
        ...
        { t:'ul', v:[
          ...
          "En matière de حُدُود → Nukūl ne suffit pas pour condamner, la preuve directe est toujours requise.",
      ...
      {
        id: "qad-04",
        title: "Qaḍāʾ — Le Juge et l'Administration de la Justice",
        status: 'available',
        content: [
        {"t": "lead", "v": "Le قَضَاء (système judiciaire islamique) est l'institution par laquelle Allah's loi est appliquée dans les litiges. Le Mukhtasar Khalīl (pp. 230-240) précise les conditions du juge et les règles du procès."},
        ...
        { t:'ul', v:[
          ...
          "<strong>Ijtihād :</strong> connaissance suffisante du فقه pour statuer ou référencer — pas besoin d'être le plus grand savant.",
      ...
      },
      {
        ...
        status: 'available',
        content: [
        {"t": "lead", "v": "Shahādāt وQaḍāʾ s'appliquent-ils pour les Muslims vivant en pays non-islamique ? Synthèse des positions de doctrine-malikite.fr et des savants malikites contemporains."},
        ...
        { t:'ul', v:[
          ...
          "Il doit dire la vérité — Yamīn al-Ghammūs reste حَرَام quel que soit le tribunal.",
      ...
      quiz: {
        ...
        title: 'Questionnaire — ' + "Shahādāt وQaḍāʾ",
        status: 'available',
        score: null,
        questions: [
                {
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Position malikite et chāfiʿite : في الأَموَال, un seul témoin + serment du demandeur = preuve suffisante. Hadīth : le Prophète ﷺ a statué avec un شَاهِد + يَمِين dans les affaires de dette. Les hanafites n'admettent pas ce mode de preuve. Ne s'applique pas aux حُدُود Qiṣāṣ."
        },
        {
          id: "q-qad-04",
        ...
        {
          id: "q-qad-07",
          text: "La règle « Bayyinaُ عَلَى المُدَّعِي » signifie :",
          choices: [
          ...
          correctId: "b",
          explanation: "Hadīth fondamental : « Bayyinaُ عَلَى المُدَّعِي وَal-yamīnُ عَلَى مَن أَنكَرَ » — la preuve incombe au demandeur, le serment (de déni) au défendeur. C'est le principe de présomption d'innocence islamique : الأَصل البَرَاءَة — l'innocence est l'état par défaut."
        },
        {
          id: "q-qad-08",
          ...
          correctId: "b",
          explanation: "L'Iqrār (aveu) n'est valide que s'il est libre, conscient et volontaire. Un aveu obtenu sous contrainte physique ou psychologique est nul. C'est une garantie fondamentale du droit islamique contre les aveux forcés — particulièrement importante pour les حُدُود."
        },
        {
          id: "q-qad-09",
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Distinction fondamentale : la فَتوَى est un avis juridique consultatifُ الاتِّبَاع دِيانَةً لَيسَ قَضَاءً) — elle s'impose moralement mais n'est pas exécutoire légalement. Le قَضَاء du juge est exécutoire. Une fatwa ne devient exécutoire que si un juge l'adopte comme jugement."
        },
        {
          id: "q-qad-11",
        ...
        {
          id: "q-qad-12",
          text: "La majorité des savants malikites classiques autorisent-ils une femme à être قَاضِيَة (juge) ?",
          choices: [
          { id:"a", text:"Oui — sans restriction" },
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Pour les حُدُود (peines coraniques), certains savants malikites permettent la rétractation de l'aveu avant l'exécution — le doute dans les حُدُود est toujours favorable à l'accusé. Pour les droits civils (créances, dommages), la rétractation de l'aveu est généralement irrecevable une fois prononcé devant le juge."
        },
        {
          id: "q-qad-16",
          ...
          correctId: "b",
          explanation: "Mukhtasar Khalīl : عَدَم التُّهمَة (absence de conflit d'intérêt) est une condition du témoignage. L'ennemi déclaré témoignant contre son ennemi est disqualifié — même s'il est habituellement honorable. Le conflit d'intérêt personnel crée une présomption de partialité irréfutable."
        },
        {
          id: "q-qad-17",
    ...
    /* ═══ الجِنَايَات وḤudūd ═══ */
    {
      ...
      icon: "shield",
      description: "Droit pénal islamique : Qiṣāṣ (talion), Diyāt (compensations) Ḥudūd (peines coraniques).",
      ...
      badge: {
        ...
        icon: 'wall-h', color: 'gold',
        unlockCondition: 'Obtenir ≥ 85 % au questionnaire ' + "الجِنَايَات وḤudūd"
      },

      lessons: [
              {
        id: "hud-01",
        title: "Qiṣāṣ وDiyāt — Talion et Compensations",
        status: 'available',
        content: [
        ...
        { t:'ul', v:[
          ...
          "Mukhtasar Khalīl : le قِصَاص s'applique aussi aux blessures intentionnelles si la blessure est délimitable."
        ] },
        ...
        { t:'ul', v:[
          ...
          "<strong>الدِّية المُغَلَّظَة :</strong> دِية alourdie (100 chameaux répartis en groupes de 30 tebas, 30 hiqqāt, 40 enceintes) Shibh al-ʿAmd.",
          "<strong>ʿĀʿĀqila :</strong> dans le meurtre non intentionnel, la دِية est supportée collectivement par le groupe familial du meurtrier — pas par lui seul."
        ] },
        {"t": "note", "v": "Le systèQiṣāṣ / دِية est profondément humaniste : il donne à la famille de la victime le choix entre la justice (talion), la réparation (compensation) et la miséricorde (pardon). La pression sociale dans l'Islam encourage le pardon — mais ne l'impose jamais."}
        ]
      },
      {
        id: "hud-02",
        title: "مَفهُوم Ḥudūd — Les Peines Coraniques : Principes et Cadre",
        status: 'available',
        content: [
        {"t": "lead", "v": "Ḥudūd sont les peines fixées par le Coran et la Sunna pour des infractions précises. Leur compréhension exige de saisir le cadre global — conditions, doutes, et finalité — avant de traiter chaque حَدّ séparément."},
        {"t": "h", "v": "Définition et liste des حُدُود"},
        { t:'ul', v:[
          "Terme : حَدّ = frontière, limite fixée par Allah.",
          "<strong>6 حُدُود en rite malikite :</strong> (1) al-zinā (adultère/fornication) ; (2) القَذف (fausse accusation d'adultère) ; (3) الشُّرب (consommation d'alcool) ; (4) al-sariqa (vol) ; (5) الحِرَابَة (brigandage) ; (6) al-ridda (apostasie).",
          "Le Mukhtasar Khalīl les traite dans cet ordre aux pp. 250-260."
        ] },
        {"t": "h", "v": "Shubha — Le Doute comme Protection"},
        {"t": "p", "v": "Principe cardinal : « Ḥudūdُ تُدرَأُ بِShubuhātِ » — les حُدُود sont levés par le doute. Toute ambiguïté sérieuse dans les preuves, les conditions ou l'intention empêche l'application du حَدّ."},
        { t:'ul', v:[
        ...
        { t:'ul', v:[
          ...
          "Pas de contrainte — la contrainte empêche le حَدّ.",
          "Pas d'ignorance excusable — celui qui ignorait l'interdiction n'est pas soumis au حَدّ.",
          "Tawba avant la poursuite : debated — certains savants malikites le prennent en compte."
        ] },
        {"t": "h", "v": "Taʿzīr — Peine Discrétionnaire"},
        {"t": "p", "v": "Pour les infractions sans حَدّ fixé, le juge Taʿzīr (peine discrétionnaire adaptée) : amende, emprisonnement, flagellation légère, blâme public, etc. Taʿzīr est le outil juridique principal du droit pénal islamique contemporain."},
        {"t": "note", "v": "Point crucial pour la compréhension contemporaine : les conditions d'application des حُدُود dans leur cadre original (État islamique, témoins parfaits, preuves irréfutables) étaient si strictes que les حُدُود étaient rarement exécutés. Leur fonction première était dissuasive et éducative, pas punitive."}
        ]
      },
      {
        id: "hud-03",
        title: "حَدّ al-sariqa والحِرَابَة — Vol et Brigandage",
        status: 'available',
        content: [
        {"t": "lead", "v": "حَدّ al-sariqa (amputation pour vol qualifié) et Ḥadd al-ḤḤadd al-Ḥirāba (brigandage armé) sont les deux حُدُود liés aux atteintes aux biens. Leurs conditions sont nombreuses et strictes — le Mukhtasar Khalīl (pp. 252-256) les détaille avec précision."},
        {"t": "h", "v": "حَدّ al-sariqa — Conditions cumulatives"},
        ...
        { t:'ul', v:[
          ...
          "<strong>2. ḤḤirz :</strong> le bien volé doit être dans un endroit sécurisé (maison fermée, coffre, boutique fermée). Voler dans un espace public sans gardien = pas de حَدّ.",
          "<strong>3. الأَخذ خُفيَة :</strong> pris en cachette — l'arrachage à force n'est pas un vol qualifié.",
          "<strong>4. عَدَم Shubha :</strong> pas de droit réel ou prétendu sur le bien. Ex : un père volant le bien de son fils → pas de حَدّ.",
        ...
        { t:'ul', v:[
          ...
          "La pauvreté absolue crée une شُبهَة → حَدّ levé."
        ] },
        {"t": "h", "v": "Ḥadd al-ḤḤadd al-Ḥirāba — Le Brigandage Armé"},
        ...
        { t:'ul', v:[
          ...
          "Tawba avant arrestation → supprime le حَدّ selon l'opinion malikite (Coran 5:34)."
        ] },
        {"t": "note", "v": "Niṣāb : le rite malikite fixe le minimum à 1/4 dinar d'or (valeur approximative d'environ 1g d'or = environ 60-70€ en 2024). En dessous de cette valeur → pas de حَدّ al-sariqa Taʿzīr. C'est l'une des valeurs les plus basses parmi les 4 madhāhib."}
        ]
      },
      {
        id: "hud-04",
        ...
        {"t": "h", "v": "حَدّ al-zinā — La Fornication/Adultère"},
        { t:'ul', v:[
          ...
          "Mukhtasar Khalīl : la grossesse hors mariage SEULE n'est pas une preuve de زِنَا — elle peut être due à une erreur."
        ] },
        {"t": "h", "v": "ḤḤadd al-Qadhf — La Fausse Accusation d'Adultère"},
        { t:'ul', v:[
          "Accuser quelqu'un d'adultère sans 4 témoins → 80 coups de fouet.",
          "Protection de l'honneur — l'une des 5 مَقَاصِد Sharīʿa.",
          "Conditions : la victime est Muslim, libre, muhsan (marié ou pas ?), nie l'accusation.",
          "Le repentir lève-t-il le ḤḤadd al-Qadhf ? Débat interne — selon l'Imām Mālik : non, le حَدّ est un droit de la victime (pas d'Allah), donc seule la victime peut pardonner."
        ] },
        {"t": "h", "v": "ḤḤadd al-Shurb — La Consommation d'Alcool"},
        { t:'ul', v:[
          ...
          "Mukhtasar Khalīl : si boire pour raison médicale sur prescription → pas de حَدّ."
        ] },
        {"t": "h", "v": "حَدّ al-ridda — L'Apostasie"},
        { t:'ul', v:[
      ...
      {
        id: "hud-05",
        title: "Ḥudūd فِي السِّيَاق المُعَاصِر — Compréhension et Application",
        status: 'available',
        content: [
        ...
        {"t": "h", "v": "مَقَاصِد Sharīʿa — Les Finalités de la Loi Islamique"},
        {"t": "p", "v": "Les حُدُود s'inscrivent dans le cadre des 5 finalités de la شَرِيعَة que le fiqh malikite, via Imām al-Ghazālī et Ibn Rushd, a systématisées :"},
        { t:'ul', v:[
          "<strong>1. حِفظُ الدِّين :</strong> protection de la religion → حَدّ al-ridda.",
          "<strong>2. حِفظُ النَّفس :</strong> protection de la vie → Qiṣāṣ.",
          "<strong>3. حِفظُ العَقل :</strong> protection de l'intellect → ḤḤadd al-Shurb.",
          "<strong>4. حِفظُ النَّسل :</strong> protection de la lignée → حَدّ al-zinā.",
          "<strong>5. حِفظُ المَال :</strong> protection des biens → حَدّ al-sariqa."
        ] },
        ...
        { t:'ul', v:[
          ...
          "Doctrine-malikite.fr souligne que les finalités des حُدُود sont permanentes ; les modalités d'application peuvent varier selon le contexte.",
          "En pays non islamique : aucun حَدّ n'est applicable — la loi civile s'impose.",
          "L'injustice sociale (pauvreté, oppression) crée des شُبُهَات qui lèvent les حُدُود — Sayyidnā ʿUmar n'a pas appliqué le حَدّ al-sariqa pendant l'année de famine."
        ] },
      ...
      quiz: {
        ...
        title: 'Questionnaire — ' + "الجِنَايَات وḤudūd",
        status: 'available',
        score: null,
        questions: [
                {
          ...
          { id:"b", text:"Qiṣāṣ (talion) / Diya (compensation) / العَفو (pardon)" },
          { id:"c", text:"Porter plainte, négocier ou abandonner" },
          { id:"d", text:"Réclamer le حَدّ, la دِية Taʿzīr" }
          ],
          correctId: "b",
          explanation: "Le وَلِيُّ الدَّم (ayant-droit du sang) a 3 options : (1) Qiṣāṣ — exiger le talion ; (2) Diya — accepter la compensation financière ; (3) العَفو — pardonner gratuitement, ce qui est islamiquement le plus méritoire. Coran 5:45 : le pardon est une expiation pour lui."
        },
        {
          id: "q-hud-02",
          text: "Si 10 personnes ont tué ensemble une seule personne, sont-elles toutes passibles du قِصَاص ?",
          choices: [
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "La دِية de base pour le meurtre intentionnel est 100 chameaux ou leur équivalent en or/argent selon l'époque. La دِية المُغَلَّظَة (alourdie) Shibh al-ʿAmd (meurtre quasi-intentionnel) est répartie en 30 tebas + 30 hiqqāt + 40 chameaux enceintes."
        },
        {
          id: "q-hud-04",
          text: "La ʿĀʿĀqila : qui supporte la دِية Qatl al-Khaṭaʾ ?",
          choices: [
          ...
          correctId: "c",
          explanation: "Qatl al-Khaṭaʾ (meurtre non intentionnel), la دِية est supportée par ʿĀʿĀqila — le groupe familial/tribal du meurtrier, collectivement et répartie sur 3 ans. Le meurtrier lui-même ne la paye pas personnellement. Cette solidarité familiale est un système de sécurité sociale islamique préislamique validé par l'Islam."
        },
        {
          id: "q-hud-05",
          text: "Un homme vole une valeur inféNiṣāb (seuil minimum). Y a-t-il un حَدّ al-sariqa ?",
          choices: [
          { id:"a", text:"Oui — tout vol engage le حَدّ" },
          { id:"b", text:"Non — Niṣāb (1/4 dinar d'or en rite malikite), c'Taʿzīr, pas le حَدّ" },
          { id:"c", text:"Seulement si c'est un récidiviste" },
          { id:"d", text:"Non seulement si c'est un pauvre" }
          ],
          correctId: "b",
          explanation: "Niṣāb (seuil minimum) pour le حَدّ al-sariqa est 1/4 dinar d'or en rite malikite (environ 1g d'or). En dessous → Taʿzīr (peine discrétionnaire). Au dessus + toutes les autres conditions → حَدّ. C'est une des valeurs les plus basses parmi les 4 écoles."
        },
        {
          id: "q-hud-06",
          text: "<strong>CRUCIALE :</strong> La condition du ḤḤirz — qu'est-ce que c'est et pourquoi est-elle essentielle ?",
          choices: [
          { id:"a", text:"La valeur minimale volée" },
          { id:"b", text:"Le lieu sécurisé d'où le bien a été volé — sans ḤḤirz, pas de حَدّ" },
          { id:"c", text:"L'intention du voleur" },
          { id:"d", text:"Le nombre de témoins" }
          ],
          correctId: "b",
          explanation: "ḤḤirz = lieu protégé/sécurisé. Le bien doit avoir été volé dans un endroit qui le protégeait normalement : maison fermée, boutique fermée, coffre, voiture verrouillée. Voler dans un espace public non gardé → pas de حَدّ. Cette condition protège les pickpockets opportunistes d'une peine démesurée."
        },
        {
          id: "q-hud-07",
          ...
          correctId: "c",
          explanation: "La زِنَا requiert 4 témoins oculaires ayant vu l'acte sexuel consommé (pas l'approche, mais l'acte lui-même selon Mukhtasar Khalīl). Ce seuil quasi-impossible à atteindre protège la vie privée. Moins de 4 témoins → les témoins risquent eux-mêmes le ḤḤadd al-Qadhf (fausse accusation)."
        },
        {
          id: "q-hud-08",
          text: "La grossesse hors mariage prouve-t-elle automatiquement la زِنَا ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Position malikite nuancée : la grossesse hors mariage seule n'est pas une preuve suffisante de زِنَا. Elle peut résulter d'un وَطء شُبهَة (rapport dans une situation de méprise sur la licéité). Le doute lève toujours le حَدّ. Seul un aveu explicite ou 4 témoins permettent d'appliquer le حَدّ."
        },
        {
          id: "q-hud-09",
          text: "Combien de coups dans le ḤḤadd al-Shurb (alcool) selon l'Imām Mālik ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Spécificité malikite : l'Imām Mālik fixe le ḤḤadd al-Shurb à 40 coups, se basant sur la pratique du Prophète ﷺ et d'Abū Bakr. Les écoles hanafite et chāfiʿite optent pour 80 coups (basées sur la pratique d'ʿUmar). C'est une divergence authentique entre les écoles sur ce حَدّ."
        },
        {
          id: "q-hud-10",
          text: "Le ḤḤadd al-Qadhf (fausse accusation d'adultère) peut-il être pardonné par la victime ?",
          choices: [
          { id:"a", text:"Non — c'est un droit d'Allah, non remissible" },
          { id:"b", text:"Oui — c'est un droit de la victime ; elle seule peut pardonner et lever le حَدّ" },
          { id:"c", text:"Oui avec accord du juge" },
          { id:"d", text:"Non sauf si l'accusé prouve la vérité" }
          ],
          correctId: "b",
          explanation: "Position malikite : le ḤḤadd al-Qadhf est un حَقّ آدَمِيّ (droit humain), pas un حَقّ إِلَهِيّ. La victime de la calomnie peut donc pardonner et lever le حَدّ. Le repentir de l'accusé seul ne suffit pas — c'est à la victime de décider. C'est différent des حُدُود qui sont حَقّ الله."
        },
        {
          id: "q-hud-11",
        ...
        {
          id: "q-hud-12",
          text: "Le principe « Ḥudūdُ تُدرَأُ بِShubuhātِ » signifie :",
          choices: [
          ...
          correctId: "b",
          explanation: "Hadīth : « ادرَءُوا Ḥudūdَ بِShubuhātِ » — « levez les حُدُود par les doutes. » C'est l'un des principes fondamentaux du droit pénal islamique. Toute شُبهَة sérieuse (doute sur la preuve, l'intention, les conditions, l'ignorance excusable...) suffit pour empêcher l'application du حَدّ."
        },
        {
          id: "q-hud-13",
          text: "Sayyidnā ʿUmar a suspendu le حَدّ al-sariqa pendant l'année de famine. Pourquoi ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Sayyidnā ʿUmar ﵁ a suspendu le حَدّ al-sariqa pendant l'année de famine car la nécessité Ḍarūra crée une شُبهَة — quelqu'un qui vole pour survivre à une famine n'est pas dans la même situation morale qu'un voleur ordinaire. Ce précédent est fondamental dans la jurisprudence malikite."
        },
        {
          id: "q-hud-14",
          text: "Les حُدُود s'appliquent-ils en France ou en Europe selon doctrine-malikite.fr ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Doctrine-malikite.fr : en pays non islamique, les Muslims sont soumis à la loi civile locale. Les حُدُود nécessitent un État islamique établi, un juge qualifié, et toutes les conditions d'application. Aucune de ces conditions n'existe en Europe. Toute tentative d'appliquer des peines islamiques hors de ce cadre serait illicite et illegale."
        },
        {
          id: "q-hud-15",
        ...
        {
          id: "q-hud-16",
          text: "Les 5 مَقَاصِد Sharīʿa sont :",
          choices: [
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Coran 5:34 est explicite : « إِلَّا الَّذِينَ تَابُوا مِن قَبلِ أَن تَقدِرُوا عَلَيهِم » — les brigands qui se repentent AVANT d'être arrêtés sont exemptés du حَدّ. C'est une invitation coranique au retour sincère. Après arrestation → Tawba est toujours recommandée mais le حَدّ reste."
        },
        {
          id: "q-hud-18",
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Taʿzīr est la peine discrétionnaire adaptée par le قَاضٍ à chaque cas. Elle peut être : amende, emprisonnement (court ou long), blâme public, exclusion de la communauté, surveillance, travaux d'intérêt général, ou flagellation légère. Taʿzīr est l'outil pénal islamique principal pour les infractions sans حَدّ fixé."
        },
        {
          id: "q-hud-20",
          text: "Quel est le principe humaniste fondamental qui différencie l'approche malikite des حُدُود ?",
          choices: [
          { id:"a", text:"Appliquer les peines le plus rapidement possible" },
          { id:"b", text:"Maximiser les doutes pour limiter l'application des حُدُود — la prudence et la miséricorde prévalent sur la sévérité" },
          { id:"c", text:"Appliquer les حُدُود uniquement pour les étrangers" },
          { id:"d", text:"Réserver les حُدُود aux récidivistes" }
          ],
          correctId: "b",
          explanation: "La méthode malikite sur les حُدُود est marquée par la prudence. L'Imām Mālik cite de nombreuses conditions et شُبُهَات dans la Muwattaʾ et la Mudawwana. Sayyidnā ʿUmar a suspendu le حَدّ al-sariqa en temps de crise. Le principe « تُدرَأُ بِShubuhātِ » est appliqué généreusement — la miséricorde prime sur la sévérité."
        }
        ]
      }
    },
    ...
    /* ═══ Iḥsān وTazkiya ═══ */
    {
      ...
      badge: {
        ...
        icon: 'heart-r', color: 'gold',
        unlockCondition: 'Obtenir ≥ 85 % au questionnaire ' + "Iḥsān وTazkiya"
      },

      lessons: [
              {
        id: "ihs-01",
        title: "Iḥsān — Le Troisième Pilier du Curriculum Islamique",
        status: 'available',
        content: [
        ...
        { t:'ul', v:[
          ...
          "Le حَجّ enseigne l'obéissance et la soumission totale.",
      ...
      },
      {
        ...
        {"t": "h", "v": "4. Ṣabr وShukr — Patience et Gratitude"},
        { t:'ul', v:[
        ...
        {"t": "note", "v": "Ordre des stations selon le Matn d'Ibn Āshir : Tawba → Zuhd → Tawakkul → Ṣabr → Shukr → الخَوف → الرَّجَاء → Maḥabba → المَعرِفَة. Chaque station prépare la suivante. Il n'est pas nécessaire de les « compléter » séquentiellement — elles se renforcent mutuellement tout au long de la vie."}
        ]
      },
      {
        id: "ihs-03",
        ...
        { t:'ul', v:[
          ...
          "Distinguer : Kibr (orgueil de l'âme) ≠ العِزَّة (dignité légitime)."
        ] },
        ...
        { t:'ul', v:[
          ...
          "<strong>Remède :</strong> faire un duʿāʾ sincère pour la personne enviée, rappeler que les rizques sont fixés par Allah, rechercher la GhiḅGhiḅṭa (désirer avoir pareil sans vouloir sa disparition chez l'autre) à la place du حَسَد.",
        ...
        {"t": "note", "v": "Méthode al-Ghazālī (adoptée par Ibn Āshir) Tazkiya : (1) Murāqaba (surveiller ses intentions) ; (2) Muḥāsaba (bilan quotidien de l'âme) ; (3) Mujāhada (effort sur l'âme) ; (4) المُعَاقَبَة (pénaliser l'âme pour ses erreurs par des actes supplémentaires d'adoration)."}
        ]
      },
      {
        id: "ihs-04",
        title: "الأَخلَاق Islāmِيَّة — L'Éthique Sociale selon le Rite Malikite",
        status: 'available',
        content: [
      ...
      {
        id: "ihs-05",
        title: "Murāqaba وMuḥāsaba — Surveillance et Bilan de l'Âme",
        status: 'available',
        content: [
        ...
        { t:'ul', v:[
          ...
          "<strong>ṢṢiyām :</strong> maîtrise des désirs — éṢabr Tawakkul.",
          "<strong>Zakāt :</strong> guérison du حُبّ المَال (attachement à l'argent) — éZuhd.",
          "<strong>Ḥajj :</strong> soumission totale — école de الانقِيَاد وMaḥabba.",
          "<strong>قِيَامُ اللَّيل :</strong> communion nocturne avec Allah — la plus haute éMurāqaba."
        ] },
      ...
      quiz: {
        ...
        title: 'Questionnaire — ' + "Iḥsān وTazkiya",
        status: 'available',
        score: null,
        questions: [
                {
          ...
          correctId: "b",
          explanation: "Hadīth de Gabriel (Muslim) : le Prophète ﷺ définit l'Iḥsān comme « أَن تَعبُدَ اللَّهَ كَأَنَّكَ تَرَاهُ فَإِن لَم تَكُن تَرَاهُ فَإِنَّهُ يَرَاكَ ». C'est la conscience permanente de la Présence divine qui transforme chaque acte en adoration authentique."
        },
        {
          id: "q-ihs-02",
        ...
        {
          id: "q-ihs-03",
          text: "Le زُهد (détachement du monde) signifie-t-il être pauvre et posséder peu ?",
          choices: [
        ...
        },
        {
          ...
          { id:"d", text:"Tawakkul avec le زُهد" }
          ],
          correctId: "a",
        ...
        {
          id: "q-ihs-05",
          text: "La GhiḅGhiḅṭa diffère du حَسَد en ce que :",
          choices: [
          { id:"a", text:"La GhiḅGhiḅṭa est plus grave" },
          { id:"b", text:"La GhiḅGhiḅṭa = désirer le même bien sans vouloir que l'autre le perde ; le حَسَد = désirer la perte du bien chez l'autre" },
        ...
        },
        {
          ...
          correctId: "b",
          explanation: "Sayyidnā ʿUmar ﵁ : « حَاسِبُوا أَنفُسَكُم قَبلَ أَن تُحَاسَبُوا » — l'auto-évaluation quotidienne précède l'évaluation divine. Le Matn d'Ibn Āshir recommande ce bilan avant le sommeil : Shukr pour les bonnes actions, demander pardon pour les fautes, identifier les opportunités manquées."
        },
        {
          id: "q-ihs-09",
          text: "Le ḤḤiqd (rancœur) : combien de temps Islam tolère-t-il la brouille entre Muslims ?",
          choices: [
          { id:"a", text:"1 an" },
          { id:"b", text:"1 semaine" },
        ...
        },
        {
          ...
          { id:"b", text:"Murāqaba (surveiller ses intentions) + Muḥāsaba (bilan) + Mujāhada (effort sur l'âme) + المُعَاقَبَة (se pénaliser pour ses fautes)" },
          { id:"c", text:"Lire, mémoriser, enseigner, pratiquer" },
          { id:"d", text:"Repentir, prière de nuit, jeûne et sadaqa" }
          ],
          correctId: "b",
          explanation: "La méTazkiya d'al-Ghazālī (adoptée par Ibn Āshir) : (1) Murāqaba — surveiller ses intentions avant l'acte ; (2) Muḥāsaba — évaluer ses actions après l'acte ; (3) Mujāhada — lutter contre les tendances négatives de l'âme ; (4) المُعَاقَبَة — se pénaliser pour les fautes par des actes d'adoration supplémentaires."
        },
        {
          id: "q-ihs-13",
          text: "Le قِيَامُ اللَّيل (prière de nuit) : pourquoi est-il la plus haute éMurāqaba ?",
          choices: [
          ...
          correctId: "b",
          explanation: "Le قِيَامُ اللَّيل est la plus pure éMurāqaba car il est accompli dans la solitude nocturne, hors de tout regard humain — Riyāʾ (ostentation) possible. Hadīth : « Notre Seigneur descend au dernier tiers de la nuit... » — moment de proximité maximale avec Allah. Coran 73:1-6 : « La prière nocturne est plus impressionnante et plus propice à la sincérité du discours. »"
        },
        {
          id: "q-ihs-14",
          ...
          { id:"b", text:"Non — l'Iḥsān est le sommet d'un édifice dont le فِقه (les actes corrects) est la fondation indispensable" },
          { id:"c", text:"Oui si on a la bonne intention" },
          { id:"d", text:"Non seulement les savants peuvent pratiquer l'إِحسَان" }
          ],
          correctId: "b",
          explanation: "Le triptyque du Matn d'Ibn Āshir est hiérarchique : l'Islām précède l'Īmān (croyance correcte) qui précède l'Iḥsān (excellence spirituelle). Sans fondations فِقه solides, la « spiritualité » flotte dans le vide. Une adoration incorrecte ne peut pas être excellente — elle doit d'abord être valide."
        },
        {
          id: "q-ihs-15",
          ...
          correctId: "c",
          explanation: "Coran 51:56 : « وَمَا خَلَقتُ الجِنَّ وَالإِنسَ إِلَّا لِيَعبُدُونِ » — « Je n'ai créé les djinns et les hommes que pour M'adorer. » C'est le verset qui couronne et justifie tout le curriculum islamique : Fiqh (pratiquer correctement), Īmān (croire sincèrement), Iḥsān (adorer avec excellence) — tout converge vers l'adoration consciente et sincère d'Allah."
        }
        ]
      }
    }
